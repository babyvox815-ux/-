const CACHE='용호운동-v26';
const ASSETS=['./','./index.html','./styles.css?v=21','./image-fix.css?v=25','./image-layout-v26.css?v=26','./assets.js?v=25','./app.js?v=26','./manifest.webmanifest'];
